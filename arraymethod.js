...
//solving problems using array function on the rest countries data/;(https://restcountries.com/v3.1/all).
...
//c)print the following details name,capital,flag using forEachfunction:
